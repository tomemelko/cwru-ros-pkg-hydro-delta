// delta_des_state_generator.h header file //
// wsn; Feb, 2015
// include this file in "delta_des_state_generator.cpp"
...
#ifndef DELTA_DES_STATE_GENERATOR_H_
#define DELTA_DES_STATE_GENERATOR_H_
